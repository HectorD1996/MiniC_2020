...
Error =  "/*" [^*]
 //PalabrasReservada = "void"|"int"|"double"|"bool"|"string"|"class"|"const"|"interface"|"null"|"this"|"extends"|"implements"|"for"|"while"|"foreach"|"if"|"else"|"return"|"break"|"New"|"New Array"|"Console"|"WriteLine"
...
"const" { System.out.print(yytext());  return symbol(sym.CONST, new Integer(1));}//NUEVO
...
"foreach" { System.out.print(yytext());  return symbol(sym.FOREACH, new Integer(1));}//NUEVO
...
"Console.Writeline" { System.out.print(yytext());  return symbol(sym.CONSOLE, new Integer(1));}//NUEVO
//"WriteLine" { System.out.print(yytext());  return symbol(sym.WRITELINE, new Integer(1));}//NUEVO
...
":" { System.out.print(yytext()); return symbol(sym.DPERIOD); }
